...
Button btnStart, btnCredits, btnSettings, btnQuit;
...
void setup() {
  ...
  btnStart    = new Button("Start", 70, 200, 160, 50);
  btnCredits    = new Button("Credits:", 70, 300, 160, 50);
  btnSettings    = new Button("Settings", 360, 200, 160, 50);
  btnQuit    = new Button("Quit", 360, 300, 160, 50);
}
